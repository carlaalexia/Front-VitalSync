...
function Login() {
  ...
  return (
    <div className="flex justify-center mt-5">
      <div className="max-w-md bg-[#51a092] bg-opacity-40 rounded-md p-14 shadow-md">
        <div className="sm:mx-auto sm:w-full sm:max-w-sm">
          <h3 className="block text-xl font-semibold leading-4 mt-6 text-center">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <p className="mt-7 text-center text-sm text-gray-800 mb-4">
            ¿No sos socio?
            <Link
              to="/CreateUser"
              className="font-semibold leading-6 text-cyan-950 hover:text-cyan-800 ml-2"
            >
              Registrate
            </Link>
          </p>
